...
enum layers { MAC_BASE, MAC_FN, WIN_BASE, WIN_FN, MIDI };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MIDI] = LAYOUT_ansi_92(
        _______,  _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  QK_MIDI_TOGGLE,  _______,
